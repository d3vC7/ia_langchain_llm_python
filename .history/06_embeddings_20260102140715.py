...
# creamos una comprension de listas concatenando el campo page_content
print([elemento.page_content for elemento in data])

# verificar cuantos vectores. ha creado, 1 por cada registro del fichero csv con datos.
embedded_docs = embeddings.embed_documents([elemento.page_content for elemento in data])
print(len(embedded_docs))

# ejemplo del vector. creado para el primer registro.
