...
text_splitter_nuevo_documento =RecursiveCharacterTextSplitter.from_tiktoken_encoder(chunk_size=500)
docs_nuevo_documento = text_splitter_nuevo_documento(documents)

# cargar en chroma
db = Chroma.from_documents(docs_nuevo_documento, function_embedding,  persist_directory='./ejemplo_embedding_db')